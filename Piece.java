...
public final class Piece {
    ...
    private Piece(Point[] points)
    {
        ...
        {
            if (point.y < this.skirt[point.x])
            {
                this.skirt[point.x] = point.y;
            }
        }
    ...
    private static Piece pieceRow(Piece firstPiece)
    {
        ...
        for( int j = 0; j < 4; j++)
        {
            ...
            for(int i = 0; i < rotatedPoints.length; i++)
            {
                new_y = rotatedPoints[i].x;
                new_x = rotatedPoints[i].y;
            ...
            for(int i = 0; i < rotatedPoints.length; i++)
            {
                rotatedPoints[i].x = -1*(rotatedPoints[i].x);
            ...
            for(int i = 0; i < rotatedPoints.length; i++)
            {
                ...
                rotatedPoints[i].x += piece.height-1;
